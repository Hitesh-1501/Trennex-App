...
class HomeCategoryAdapter(
    ...
    companion object{
        const val TYPE_HOME_BANNER = 0
        const val TYPE_HOME_HEADER = 1
        const val TYPE_HOME_ITEM = 2
    }
    ...
    override fun onCreateViewHolder(
        ...
        when(viewType){
            TYPE_HOME_BANNER -> {
                val view = inflater.inflate(R.layout.item_home_banner,parent,false)
    ...
    class HeaderVH(view: View): RecyclerView.ViewHolder(view){
        val tvHeader : TextView = view.findViewById(R.id.tvHomeHeader)
    }
    class ItemVH(view: View):RecyclerView.ViewHolder(view){
        val tvName:TextView = view.findViewById(R.id.tv_home)
        val ivImage: ImageView = view.findViewById(R.id.iv_home)
    }
}