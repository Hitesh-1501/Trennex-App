...
class CartFragment : Fragment(R.layout.fragment_cart) {
    ...
    private fun render(state: CartUiState){
        ...
        state.selectedAddress?.let {
            ...
            binding.tvDeliverTo.text = "Select Delivery Address"
            binding.tvAddress.text = "Please select where to deliver your items"
        }
    ...
    private fun navigateToMapScreen(place: Place){
        val action = CartFragmentDirections.actionCartFragmentToAddNewAddressFragment(
