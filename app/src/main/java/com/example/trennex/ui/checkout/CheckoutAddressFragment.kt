...
class CheckoutAddressFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnContinue.setOnClickListener {
            Toast.makeText(requireContext(), "Payment screen coming soon", Toast.LENGTH_SHORT).show()
        }
            ...
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.uiState.collect { state ->
                    ...
                    state.selectedAddress?.let {
                        ...
                        binding.tvFullAddress.text = "Please add or select a delivery address"
    ...
    private fun showLocationBottomSheet() {
        ...
        sheetBinding.currentLocationRow.visibility = View.GONE
